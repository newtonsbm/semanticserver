...
class SemanticServerApplication extends boot_1.BootMixin(repository_1.RepositoryMixin(rest_1.RestApplication)) {
    constructor(options) {
        super(options);
...
exports.SemanticServerApplication = SemanticServerApplication;
